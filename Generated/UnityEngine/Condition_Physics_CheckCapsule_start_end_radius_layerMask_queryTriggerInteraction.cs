...
namespace React.Generated {
    ...
    [System.Serializable]
    public class Condition_Physics_CheckCapsule_start_end_radius_layerMask_queryTriggerInteraction : LeafNode
    {
        ...
        public static string GetMenuPath() => "Physics/Condition/CheckCapsule/(start, end, radius, layerMask, queryTriggerInteraction)";
    ...
    [System.Serializable]
    public class Not_Condition_Physics_CheckCapsule_start_end_radius_layerMask_queryTriggerInteraction : LeafNode
    {
        public UnityEngine.Vector3 start;
        public UnityEngine.Vector3 end;
        public float radius;
