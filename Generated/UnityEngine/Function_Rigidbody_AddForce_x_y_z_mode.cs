...
namespace React.Generated {
    ...
    [System.Serializable]
    public class Function_Rigidbody_AddForce_x_y_z_mode : LeafNode
    {
        public float x;
        public float y;
        public float z;
        ...
        public static string GetMenuPath() => "Rigidbody/Function/AddForce/(x, y, z, mode)";
        public static string Signature() => " (x,y,z,mode)";
        public override System.Type GetWrappedType() => typeof(UnityEngine.Rigidbody);

        public static int leafNodeId = ReactTypeRegister.RegisterNodeClass(typeof(UnityEngine.Rigidbody), typeof(Function_Rigidbody_AddForce_x_y_z_mode));
